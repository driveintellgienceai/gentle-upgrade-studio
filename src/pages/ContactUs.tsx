                ...
                <div className="space-y-5 text-muted-foreground">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <a href="https://maps.app.goo.gl/EtukWtX8fpsymwJN9" target="_blank" rel="noopener noreferrer" className="hover:text-primary">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p>Fri: 9:00 AM – 2:00 PM (by appointment)</p>
                    </div>
                  </div>
                </div>
              </div>
