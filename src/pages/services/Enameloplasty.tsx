...
export default function Enameloplasty() {
  return (
    <Layout>
      <PageBanner title="Enameloplasty" subtitle="Restore a healthier, more attractive smile with conservative enameloplasty (tooth contouring)" />
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl space-y-8 text-muted-foreground leading-relaxed font-body">
          ...
          <h2 className="text-2xl font-heading text-foreground">Getting to the root of enameloplasty</h2>
          <p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {[
              ...
              { src: "https://www.tootharchitectdental.com/wp-content/uploads/2024/05/Enameloplasty_shaving-teeth-conservatively-on-the-outside-to-align.jpg", label: "Enameloplasty – shaving teeth conservatively on the outside to align" },
            ].map((img) => (
          ...
          <h2 className="text-2xl font-heading text-foreground">How it's done</h2>
          <p>
