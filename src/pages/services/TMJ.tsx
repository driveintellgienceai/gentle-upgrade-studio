    ...
    <Layout>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl space-y-8 text-muted-foreground leading-relaxed font-body">
          ...
          <h2 className="text-2xl font-heading text-foreground">Getting to the root of TMJ troubles</h2>
          <p>
          ...
          <h2 className="text-2xl font-heading text-foreground">Lasting relief</h2>
          <p>
