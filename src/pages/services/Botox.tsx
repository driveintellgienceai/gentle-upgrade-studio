    ...
    <Layout>
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl space-y-8 text-muted-foreground leading-relaxed font-body">
          <h2 className="text-2xl font-heading text-foreground">Resolving TMJ troubles, other applications at the dentist's office</h2>
          <p>
          ...
          <h2 className="text-2xl font-heading text-foreground">The beauty of Botox®</h2>
          <p>
          ...
          <h2 className="text-2xl font-heading text-foreground">Schedule your consultation today!</h2>
          <p>
