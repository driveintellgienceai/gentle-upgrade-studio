...
export default function TeethWhitening() {
  return (
    <Layout>
      <PageBanner title="Teeth Whitening" subtitle="Professional whitening designed to boost your one-of-a-kind smile" />
      <section className="py-10 sm:py-16 md:py-24">
        <div className="container mx-auto px-4 max-w-3xl space-y-5 sm:space-y-8 text-sm sm:text-base text-muted-foreground leading-relaxed font-body">
          ...
          <h2 className="text-xl sm:text-2xl font-heading text-foreground">Restore the healthy, beautiful brilliance of your teeth!</h2>
          <p>
